...
DATABASES = {
    'default': {
        ...
        'NAME': _ruta_db,#'fotomov_db',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': '',#'root',
        'PASSWORD': '',#'endthen53662736',
...
SECRET_KEY = 'h3lx%4sbf0l+nm68q^80o^s**3jpw87^7@=dyhuj-oq(3wv!u0'
...
TEMPLATE_CONTEXT_PROCESSORS = (
  ...
  "fotomov.context_processors.obtener_privilegio",
)
